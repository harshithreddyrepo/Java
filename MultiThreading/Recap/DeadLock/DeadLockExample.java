package MultiThreading.Recap.DeadLock;
...
class Task2 implements Runnable{
    ...
    public void run() {
        synchronized (pen){
            paper.writeWithPaperAndPen(pen); //thread1 locks pen and paper
        }
       // paper.writeWithPaperAndPen(pen); //thread1 locks paper tries to lock pen
    }
}
